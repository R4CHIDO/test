...
<div class="col-12 grid-margin stretch-card">
 <div class="card">
  <div class="card-body">
   <h4 class="card-title">Edit the Module</h4>
   ...
   <?= form_open("Modules/editModule/" . $module->module_id) ?>


   <div class="form-group">
    <label for="exampleInputName1">Module label</label>
    <input name="module_label" value="<?= $module->module_label ?>" type="text" class="form-control" id="exampleInputName1" placeholder="Module label">
   </div>
   <div class="form-group">
    <label for="exampleInputName1">Masse Horaire</label>
    <input value="<?= $module->MH ?>" name="MH" type="number" class="form-control" id="exampleInputName1" placeholder="Masse horaire">
   </div>

   <div class="form-group">
   <label for="exampleFormControlSelect1">Select a filiere</label>

    <select value="<?= $module->filiere_id ?>" name="filiere_id" style="color: black;" class="form-control" id="exampleFormControlSelect1">
   ...
   <label for="exampleFormControlSelect1">Select a teacher</label>
    ...
    <select value="<?= $module->user_id ?>" name="user_id" style="color: black;" class="form-control" id="exampleFormControlSelect1">
